...
public class AdminBook extends User {
	
  private static final String TABLE_NAME = "AdminBook";
	
  public AdminBook(UUID user_id, String first_name, String second_name, String login, String password, UUID role_id, ServerRequest server) {
  ...
  */
  public String create() {
    return super.databaseSave(TABLE_NAME, "ab_id");
  }
